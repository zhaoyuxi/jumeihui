 ...
 */
package com.xixi.jimeihui.album;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            case AlbumFile.TYPE_IMAGE: {
                return new ImageViewHolder(mInflater.inflate(R.layout.publish_item_content_image, parent, false), mItemClickListener);
            }
            case AlbumFile.TYPE_VIDEO: {
                return new VideoViewHolder(mInflater.inflate(R.layout.publish_item_content_video, parent, false), mItemClickListener);
            }
            default: {
